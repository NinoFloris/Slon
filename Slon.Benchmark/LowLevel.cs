...
namespace PerfLabTests
{
    ...
    public class LowLevelPerf
    {
        class Config : ManualConfig
        {
            public Config()
            {
                AddJob(new SimpleJobAttribute(targetCount: 20, invocationCount: 128).Config.GetJobs().First().UnfreezeCopy()
                    .WithEnvironmentVariable("DOTNET_TieredPGO", "0")
                );
            }
        }
        public const int InnerIterationCount = 100000; // do not change the value and keep it public static NOT-readonly, ported "as is" from CoreCLR repo
        ...
        public static SuperClass aClassFil
        {
        ...
        [Benchmark(OperationsPerInvoke = InnerIterationCount)]
        ...
        [GlobalSetup(Targets = new []{nameof(ClassVirtualMethod), nameof(ClassVirtualMethodT)})]
        public void SetupClassVirtualMethod() => aClassFiled = new Class();

        [Benchmark(OperationsPerInvoke = InnerIterationCount)]
        public int ClassVirtualMethod()
        {
            SuperClass aClass = aClassFil;
        ...
        [Benchmark(OperationsPerInvoke = InnerIterationCount)]
        public int ClassVirtualMethodT()
        {
            SuperClass aClass = aClassFil;
            ...
            for (int i = 0; i < InnerIterationCount; i++)
                x = aClass.VirtualMethod<string>(null);
    ...
    public class SuperClass : AnInterface
    {
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
        public virtual int VirtualMethod<T>(T value)
        {
            return 1;
        }
    }
    ...
    public class Class : SuperClass
    {
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
        public override int VirtualMethod<T>(T value) { return aInstanceInt++; }
