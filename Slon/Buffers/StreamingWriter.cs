...
/// <summary>
/// A fast access struct that wraps <see cref="IStreamingWriter{T}"/>.
/// </summary>
/// <typeparam name="TWriter">The type of element to be written.</typeparam>
struct StreamingWriter<TWriter> : IStreamingWriter<byte> where TWriter : IStreamingWriter<byte>
{
    /// <summary>
    ...
    public readonly TWriter Output => _output;
    ...
    public void Flush(TimeSpan timeout = default) => _output.Flush(timeout);
