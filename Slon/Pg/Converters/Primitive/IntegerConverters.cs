...
sealed class Int2Converter : PgConverter<short>
{
    ...
    public override SizeResult GetSize(short value, int bufferLength, ref object? writeState, PgConverterOptions options)
...
sealed class Int4Converter : PgConverter<int>
{
    ...
    public override SizeResult GetSize(int value, int bufferLength, ref object? writeState, PgConverterOptions options)
