...
sealed class BooleanConverter : PgConverter<bool>
{
    ...
    public override SizeResult GetSize(bool value, int bufferLength, ref object? writeState, DataRepresentation representation, PgConverterOptions options)
...
sealed class ByteConverter : PgConverter<byte>
{
    ...
    public override SizeResult GetSize(byte value, int bufferLength, ref object? writeState, DataRepresentation representation, PgConverterOptions options)
        => SizeResult.Create(sizeof(byte), fixedSize: true);
...
sealed class SByteConverter : PgConverter<sbyte>
{
    ...
    public override SizeResult GetSize(sbyte value, int bufferLength, ref object? writeState, DataRepresentation representation, PgConverterOptions options)
