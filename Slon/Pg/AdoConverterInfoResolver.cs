...
class AdoConverterInfoResolver: IPgConverterInfoResolver
{
    protected static ConverterInfoMappingCollection Mappings { get; }
    static AdoConverterInfoResolver()
    {
...
sealed class AdoWithArrayConverterInfoResolver : AdoConverterInfoResolver
{
    static AdoWithArrayConverterInfoResolver()
    {
