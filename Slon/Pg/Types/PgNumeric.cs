...
using static Slon.Pg.Types.PgNumeric.Builder;
...
# else
    ...
    public readonly ref struct Builder
    {
        ...
        public const int MaxDecimalNumericDigits = 8;
        ...
        {
            // Just ask for the maximum size (128 bits), we'll slice it later.
            if (destination.Length < MaxDecimalNumericDigits)
