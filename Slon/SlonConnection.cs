...
public sealed partial class SlonConnection
{
    ...
    void ThrowIfDisposed()
    {
        ...
        static void ThrowObjectDisposed() => throw new ObjectDisposedException(nameof(SlonConnection));
    }
    ...
    {
        readonly SlonConnection _instance;

        public CommandWriter(SlonConnection instance)
        {
            _instance = instance;
        }
...
#pragma warning restore CS0197
    ...
    sealed class ConnectionOperationSource: OperationSource, IValueTaskSource<Operation>
    {
        ...
        public ConnectionOperationSource(SlonConnection connection, Protocol.Protocol protocol, bool closeConnection, bool pooled = false) :
    ...
    SlonConnection CloneCore()
    {
        ...
        return new SlonConnection(_connectionString);
    }
}

// Public surface & ADO.NET
public sealed partial class SlonConnection : DbConnection, ICloneable
{
    /// <summary>
    /// Initializes a new instance of <see cref="SlonConnection"/> with the given connection string.
    /// </summary>
    /// <param name="connectionString">The connection used to open the PostgreSQL database.</param>
    public SlonConnection(string? connectionString)
    {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="SlonConnection"/> class.
    /// </summary>
    public SlonConnection() : this(connectionString: null) { }

    internal SlonConnection(SlonDataSource dataSource) : this(dataSource.ConnectionString)
...
#else
    public ValueTask<SlonTransaction> BeginTransactionAsync(IsolationLevel level, CancellationToken cancellationToken = default)
#endif
        => new(BeginTransactionCore(IsolationLevel.Unspecified));
    ...
    protected override DbCommand CreateDbCommand() => new SlonCommand(null, this);
