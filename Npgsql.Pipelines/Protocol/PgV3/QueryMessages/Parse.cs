...
readonly struct Parse: IFrontendMessage
{
    ...
    public static void WriteMessage<T>(scoped ref SpanBufferWriter<T> buffer, string commandText, scoped in ReadOnlyMemory<KeyValuePair<CommandParameter, IParameterWriter>> parameters, string? preparedStatementName, int precomputedLength = -1)
